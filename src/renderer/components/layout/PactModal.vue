  ...
  <material-modal :show="!isAgreePact || isShowPact" max-width="70%" :bg-close="isAgreePact" :close-btn="isAgreePact" @close="handleClose(false)">
    <main :class="$style.main">
      ...
      <div class="select scroll" :class="$style.content">
        ...
        <p>词语约定：本协议中的“本项目”指 VisonCube Music 桌面版；“使用者”指签署本协议的使用者；“官方音乐平台”指对本项目内置的包括酷我、酷狗、咪咕等音乐源的官方平台统称；“版权数据”指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。</p><br>
        ...
        <p>6.1&nbsp;VisonCube Music 免费提供，本项目不对项目内技术在任何地区的法律适用性作保证。</p><br>
        ...
        <p><strong>*</strong>&nbsp;若协议更新，将在应用内展示。</p>
